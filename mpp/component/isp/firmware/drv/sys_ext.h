...
{
    SYS_VI_EVEN_DEV_CLK_SEL = 3,    /* select clock source for device 2 and 6,only valid for  hi3531*/
    SYS_VI_DEV_CLK_DIV_SEL,         /* valid for all chip */
    SYS_VI_ODD_DEV_CLK_SEL,         /* select clock source for odd devices,only valid for hi3531/3532*/
    SYS_VI_DEV_CLK_SEL,             /* select clock source for device,valid for hi3521 */
    ...
    SYS_VIU_CHN_RESET_SEL,
    SYS_VIU_CHN_CLK_EN,         /*only valid for hi3520d*/
...
typedef struct hiSYS_EXPORT_FUNC_S
{
    ...
    HI_U64  (*pfnSYSGetLocalTimeStamp)  (HI_VOID);
    ...
    HI_U32  (*pfnSYSGetChipId)  (HI_VOID);
    HI_U32  (*pfnSYSGetEfuseAddr)  (HI_VOID);
