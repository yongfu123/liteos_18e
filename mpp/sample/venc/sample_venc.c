...
{	
	...
	char* sVencWidthHeight;
	sns_type(sVencWidthHeight);
    printf("Usage : %s \n", sPrgNm);
    printf("Select the index:\n");
    printf("\t 0) 1*%s H264 + 1*VGA H264.\n", sVencWidthHeight);
    printf("\t 1) 1*%s MJPEG encode + 1*%s jpeg.\n", sVencWidthHeight, sVencWidthHeight);
...
/******************************************************************************
* function:  H.264@720p@30fps+H.264@VGA@30fps or H.264@1080p@30fps+H.264@VGA@30fps
*

******************************************************************************/
HI_S32 SAMPLE_VENC_CLASSIC(HI_VOID)
{
...
/******************************************************************************
* function :  1路720p MJPEG encode and 1路720p JPEG snap 
*             1路1080p MJPEG encode and 1 路1080p JPEG snap
*
******************************************************************************/
HI_S32 SAMPLE_VENC_MJPEG_JPEG(HI_VOID)
{
    ...
    ******************************************/
    ...
    if (HI_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("HI_MPI_VB_SetSupplementConf  failed with %d!\n", s32Ret);
...
#endif
{
    ...
    switch (c)
    {
        case '0':/* H.264@720p(or 1080p)@30fps+H.265@720p(or 1080p)@30fps+H.264@D1@30fps */
            s32Ret = SAMPLE_VENC_CLASSIC();
            break;
        case '1':/* 1*720p(or 1080p) mjpeg encode + 1*720p(or 1080p) jpeg  */
