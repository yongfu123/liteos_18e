...
void SAMPLE_VIO_InitGlobalArgs()
{
    gs_enNorm = VIDEO_ENCODING_MODE_PAL;
    g_enVoIntfType = VO_INTF_LCD;
    g_enPicSize = PIC_HD1080;
    gs_u32ViFrmRate = 0;
    g_Pool = VB_INVALID_POOLID;
    g_stViChnConfig.enViMode = APTINA_AR0130_DC_720P_30FPS;
    g_stViChnConfig.enNorm = VIDEO_ENCODING_MODE_AUTO;           /*DC: VIDEO_ENCODING_MODE_AUTO */
