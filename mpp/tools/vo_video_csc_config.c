...
static HI_VOID usage(HI_VOID)
{
	...
	#else
	printf("usage: vo_csc_config [LayerId][enCscMatrix] [Luma] [Contrast] [Hue] [Satuature]. sample: vo_csc_config 0 1 50 50 50 50\n\n");
	#endif
}
...
HI_S32 vo_video_csc_main(int argc, char* argv[])
#else
